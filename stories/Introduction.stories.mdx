...
This package is used to add all these functionality on your angular site.

https://www.npmjs.com/package/ngx-twitter-widgets
...
## Import the NgxTwitterWidgetsModule
